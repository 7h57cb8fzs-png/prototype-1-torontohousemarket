...
## Optional address completion — 2026-09-15 (prepared)
- User rejected mandatory city entry and real-home examples in form guidance. Street-only inputs now pass the public syntax preflight; city is optional in seller capture. Removed real-home examples from customer-facing helpers/errors. Existing history matching still refuses ambiguous cities.
- Both buyer and seller pages now have a separate Unit / suite field. Common pasted condo formats populate it, and changing a confirmed property clears the former unit. Actual malformed inputs retain red feedback.
- Prepared optional Google Places autocomplete, city fill from selected address components, keyboard/touch options and stale-result protection. GOOGLE_PLACES_API_KEY is not configured by this change. Without it the forms continue with manual entry; do not claim live autocomplete is activated or verified.
- The free sources tested did not reliably return the supplied addresses. Chosen provider setup and activation checks are documented in .github/ADDRESS_AUTOCOMPLETE.md. No new billing account, credential, lead, report or email was created.

- Final preview 261982d4-544f-4edf-9164-466164cb25b9, source SHA256 384c6bbdad50dda64bb1319cee8e2318c4aacdde324bffe0ec56bcbecc59c3c8, commit 155bbc04e13b0ee8a2eeec5e75efcd1152493c93, successful run 35005365907. All 46 focused tests and 15 asset checks passed. Mobile buyer entry matched 617 Lonsdale Road to public MLS C13784322 without a city; seller entry accepted 203 Grandravine Drive and advanced without a public match. Unit-first condo entry separated unit 1405, and the malformed concatenated variant showed the short red error without real-home examples. This verifies address entry, not protected valuations. Synthetic provider tests cover selection, city fill, failure, keyboard control and stale results. Google Places live activation remains pending.

- Published successfully: Worker 261982d4-544f-4edf-9164-466164cb25b9, source SHA256 384c6bbdad50dda64bb1319cee8e2318c4aacdde324bffe0ec56bcbecc59c3c8, release commit 637cae3fe38bc698db2b3104a7a6817ba7f71772, successful run 35005591357. All 46 focused tests and 15 production asset checks passed; source, bindings and cron preserved. Production browser confirmed the city-optional seller form and separate unit field. Rollback version: 01af3042-e708-4e5d-a68b-a0c78dcac46d. Automatic suggestions remain inactive until the owner’s Google Places connection is configured and verified. No protected valuation rechecks, live leads or emails were generated in this change.
